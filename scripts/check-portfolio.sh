...
require_fixed '<h2>7) Linux Terminal Learning Application and Glossary</h2>' "Linux Learning item title is not using the strengthened terminal-learning framing"
...
require_fixed '<img class="portfolio-logo-image" src="images/linux-learning-ii.png" alt="Linux Sysadmin Terminal Flashcards sandbox shell overview">' "Linux Learning App second screenshot is not using the expected local asset markup"
require_fixed '<img class="portfolio-logo-image" src="images/linux-learning-iii.png" alt="Linux Sysadmin Terminal Flashcards uptime practice card">' "Linux Learning App third screenshot is not using the expected local asset markup"
